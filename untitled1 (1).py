...
Original file is located at
    https://colab.research.google.com/drive/1tEeY52WZbsBtutBoilcOLcPQSAly80X5
"""
...
ZIP_PATH = '/content/drive/MyDrive/IA/P2/data/eleicao.zip'
CSV_FILE1 = '/content/drive/MyDrive/IA/P2/Luana Mendes Alves - consulta_cand_2020_RJ.csv'
CSV_FILE2 = '/content/drive/MyDrive/IA/P2/Luana Mendes Alves - receitas_candidatos_2020_RJ.csv'
CSV_FILE3 = '/content/drive/MyDrive/IA/P2/Luana Mendes Alves - despesas_contratadas_candidatos_2020_RJ.csv'
...
def main():
    ...
    with open('/content/drive/MyDrive/IA/P2/data/election_train_test_scaler.pkl', 'rb') as f:
